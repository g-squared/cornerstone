    ...
    grunt.initConfig({
        ...
        concat: {
            ...
            css: {
                ...
                dest: '../servlets/web/css/cornerstone.css',
            },
            dist: {
                options: {
                    stripBanners: true,
                ...
                src : ['build/built.js'],
                dest: '../servlets/web/script/cornerstone.js'
            }
        },
        uglify: {
            dist: {
                files: {
                    '../servlets/web/script/cornerstone.min.js': ['../servlets/web/script/cornerstone.js']
                }
            },
            options: {
                banner: '/*! <%= pkg.name %> - v<%= pkg.version %> - ' +
        ...
        cssmin: {
            dist: {
                files: {
                    '../servlets/web/css/cornerstone.min.css': ['../servlets/web/css/cornerstone.css']
                }
            }
        }
